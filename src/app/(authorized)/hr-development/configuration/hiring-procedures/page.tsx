...
function ListHiringProcedures() {
    ...
    useEffect(() => {
        async function loadHiringProcedures(){
            try{
                const data = await libService.getOfflineLibHiringProcedure() as any;
                setData(data);
            }catch(error){
                console.error(error);
            }finally{
...
export default ListHiringProcedures